...
const RidePopUp = ({setRidePopupPanel,ride,setConfirmRidePopupPanel,confirmRide}) => {
    return (
        <div>
            ...
            <div className='flex items-center justify-between p-3 bg-yellow-400 rounded-lg mt-4'>
                <div className='flex items-center gap-3 '>
                    ...
                    <h2 className='text-lg font-medium'>{ride?.userId.fullname.firstname + " " + ride?.userId.fullname.lastname}</h2>
                </div>
